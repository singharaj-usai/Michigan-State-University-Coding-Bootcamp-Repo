...
* Implement and explain the differences between making HTTP GET requests using XMLHttpRequest, jQuery AJAX, and the Fetch API.
...
For this week's Challenge, you'll build a weather dashboard using various endpoints from the OpenWeather API.
